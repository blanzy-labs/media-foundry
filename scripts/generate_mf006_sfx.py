...
def main():
    ...
    for ordinal,event in enumerate(events):
        ...
        lengths={"electronic_motion":1.45,"circuit_draw":.55,"energy_flow":1.1,"central_overload":.3,"spark_burst":.48,"book_formation":.55,"book_open":.42,"page_flip":.28,"book_close":.48,"data_dissolve":1.15,"cta_energy":.8,"projection_emission":.8,"projection_shift":.42,"projection_collapse":1.0}; span=lengths[kind]
